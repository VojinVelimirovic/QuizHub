                          ...
                          {!q.collapsed && (
                            <>
                              <div>
                                ...
                                <input value={q.text} onChange={e => handleQuestionChange(qIndex, "text", e.target.value)} />
                              </div>
                              <div>
                                <label>Type</label>
                                <select value={q.questionType} onChange={e => handleQuestionChange(qIndex, "questionType", e.target.value)}>
                              ...
                              {q.questionType === "FillInTheBlank" ? (
                                <div>
                                  ...
                                  <input type="text" value={q.fillInAnswer} onChange={e => handleQuestionChange(qIndex, "fillInAnswer", e.target.value)} />
                                </div>
                              ) : (
                                <div>
                                  <h4>Answer Options</h4>
                                  {q.questionType !== "TrueFalse" && <button type="button" onClick={() => handleAddAnswerOption(qIndex)}>+ Add Option</button>}
                                  {q.answerOptions.map((ao, aoIndex) => (
                                    <div key={ao.id ?? ao.tempId ?? aoIndex} className="answer-option">
                                      <input 
                                        value={ao.text} 
                                      ...
                                      {q.questionType !== "TrueFalse" && q.answerOptions.length > 1 && (
